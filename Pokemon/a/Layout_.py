...
# キャラクターの画像の大きさを調整する
Pikatyu_image = pygame.transform.scale(ms.Pikatyu_image, (500, 500))
Ibui_image = pygame.transform.scale(ms.Ibui_image, (300, 300))
...
# キャラクターの作成
Ally_HpB = Character(name=ms.Pikatyu_info, hp=ms.Pikatyu_info.hp)
Allytext_name = font.render(ms.Pikatyu_info.name, True, (0, 0, 0))  # 白色のテキスト
